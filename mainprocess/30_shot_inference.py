...
def setup_cfg():
    ...
    cfg = get_cfg()
    cfg.merge_from_file("mainprocess/faster_rcnn_R_101_FPN_ft_all_ortho_30shot.yaml") # config file
    cfg.MODEL.WEIGHTS = "checkpoints/coco/faster_rcnn/faster_rcnn_R_101_FPN_ft_all_30shot/model_final.pth" # weights
