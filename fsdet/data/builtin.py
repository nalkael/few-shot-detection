...
def register_all_coco(root=root_pth):
    ...
    METASPLITS = [
        ...
        ("ortho_test_all", "merged_ortho_coco/test", "merged_ortho_coco/test/_annotations.coco.json"),
        ("ortho_test_base", "merged_ortho_coco/test", "merged_ortho_coco/test/_annotations.coco.json"),
        ("ortho_test_novel", "merged_ortho_coco/test", "merged_ortho_coco/test/_annotations.coco.json"),
    ]

    # register small meta datasets for fine-tuning stage
    for prefix in ["all", "novel"]:
        for shot in [10, 20, 30]: # set shot 
