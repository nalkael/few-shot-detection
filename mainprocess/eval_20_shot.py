...
cfg = get_cfg()
cfg.merge_from_file("mainprocess/faster_rcnn_R_101_FPN_ft_all_ortho_20shot.yaml")
cfg.MODEL.WEIGHTS = "checkpoints/coco/faster_rcnn/faster_rcnn_R_101_FPN_ft_all_20shot/model_final.pth" # cascade model without augmentation
...
with open("20_shot_predictions.pkl", "wb") as f:
    pickle.dump(predictions, f)

with open("20_shot_targets.pkl", "wb") as f:
    pickle.dump(targets, f)

# load pickel files
with open("20_shot_predictions.pkl", "rb") as f:
    predictions = pickle.load(f)

with open("20_shot_targets.pkl", "rb") as f:
...
with open('20_shot_results.txt', 'w') as f:
